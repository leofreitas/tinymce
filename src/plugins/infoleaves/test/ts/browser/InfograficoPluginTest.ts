...
UnitTest.asynctest('browser.tinymce.plugins.infografico.InfoLeavesPluginTest', function () {
  ...
  suite.test('Default image dialog on empty editor', function (editor) {
    editor.setContent('');
    editor.execCommand('mceInfoLeaves', true);
  ...
  suite.test('InfoLeaves dialog infografico_dimensions: false', function (editor) {
  ...
  suite.test('InfoLeaves recognizes relative src url and prepends relative infografico_prepend_url setting.', function (editor) {
  ...
  suite.test('InfoLeaves recognizes relative src url and prepends absolute infografico_prepend_url setting.', function (editor) {
    let win, elementId, element;
