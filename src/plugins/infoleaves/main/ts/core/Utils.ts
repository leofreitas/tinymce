...
const getInfoLeavesSize = function (url, callback) {
...
const createInfoLeavesList = function (editor, callback) {
  const imageList = Settings.getInfoLeavesList(editor);
...
const waitLoadInfoLeaves = function (editor, data, imgElm) {
  function selectInfoLeaves() {
  ...
  imgElm.onerror = selectInfoLeaves;
};
