...
const getInfosimpleSize = function (url, callback) {
...
const createInfosimpleList = function (editor, callback) {
  const imageList = Settings.getInfosimpleList(editor);
...
const waitLoadInfosimple = function (editor, data, imgElm) {
  function selectInfosimple() {
  ...
  imgElm.onerror = selectInfosimple;
};
